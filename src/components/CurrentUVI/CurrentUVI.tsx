...
import { uviDataTypes, uviExtremeData, uviHighData, uviLowData, uviModerateData, uviVeryHighData } from '../../constants/uviData';
  ...
  return (
    <div className="weather-data-children current-uvi">
      <div className="weather-data-children__container">
        ...
        <p className="weather-data-children__description current-uvi__value">{uviData && uviData.uviValue}</p>
      </div>
      <div className="weather-data-children__container">
        <img className="current-uvi__scale" src={uviData ? uviData.uviImage : scaleImg} alt="uvi scale" />
        <p className="weather-data-children__advice current-uvi__advice">{uviData && uviData.uviAdvice}</p>
      </div>
    </div>
  );
};
